 ...
 * generated in the exer2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SomaResponse_QNAME = new QName("http://exer1/", "somaResponse");
    private final static QName _Soma_QNAME = new QName("http://exer1/", "soma");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: exer2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exer1/", name = "somaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exer1/", name = "soma")
